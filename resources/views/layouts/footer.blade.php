    ...
    <!--   Core JS Files   -->
<script src="{{ asset('../assets/assets/js/core/jquery.3.2.1.min.js" type="text/javascript') }}"></script>
...
<script src="{{ asset('../assets/assets/js/plugins/bootstrap-switch.js')}}"></script>
<!--  Google Maps Plugin    -->
...
<script src="{{ asset('../assets/assets/js/light-bootstrap-dashboard.js?v=2.0.0')}} " type="text/javascript"></script>
